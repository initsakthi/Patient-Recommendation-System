            ...
            <div className="owl-carousel testimonial-carousel">
                <div className="bg-white mx-3 p-4">
                    <div className="d-flex align-items-end mb-3 mt-n4 ml-n4">
                        <img className="img-fluid" src="img/testimonial-1.jpg" style={{ width: "80px", height: "80px" }} alt="" />
                        <div className="ml-3">
                            <h5>Client Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div className="bg-white mx-3 p-4">
                    <div className="d-flex align-items-end mb-3 mt-n4 ml-n4">
                        <img className="img-fluid" src="img/testimonial-2.jpg" style={{ width: "80px", height: "80px" }} alt="" />
                        <div className="ml-3">
                            <h5>Client Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div className="bg-white mx-3 p-4">
                    <div className="d-flex align-items-end mb-3 mt-n4 ml-n4">
                        <img className="img-fluid" src="img/testimonial-3.jpg" style={{ width: "80px", height: "80px" }} alt="" />
                        <div className="ml-3">
                            <h5>Client Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div className="bg-white mx-3 p-4">
                    <div className="d-flex align-items-end mb-3 mt-n4 ml-n4">
                        <img className="img-fluid" src="img/testimonial-4.jpg" style={{ width: "80px", height: "80px" }} alt="" />
                        <div className="ml-3">
                            <h5>Client Name</h5>
                            <i>Profession</i>
                        </div>
